...
export default function SettingsForm({initialData}: ISettingsFormProps) {
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error('Certifique-se que excluiu todos os produtos e categorias primeiro.');
    } finally {
      setLoading(false);
      setOpen(false);
    }
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between">
        <Heading title="Configurações da loja" description="Gerencie as informações da sua loja" />
        <Button
          disabled={loading}
          variant="destructive"
          size="sm"
