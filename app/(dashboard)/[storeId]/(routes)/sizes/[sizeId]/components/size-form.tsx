...
export default function SizeForm({
  ...
  const description = initialData ? 'Editar a tamanho' : 'Adicionar novo tamanho';
  ...
  const onSubmit = async (data: SizeFormValues) => {
    try {
      setLoading(true);
      if (initialData) {
        await axios.patch(`/api/store/${params.storeId}/sizes/${params.sizeId}`, data);
      } else {
        await axios.post(`/api/store/${params.storeId}/sizes`, data);
      }
  ...
  const onDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/store/${params.storeId}/sizes/${params.sizeId}`);
      router.refresh();
      router.push(`/${params.storeId}/sizes`);
